...
class My extends TagLib {
	protected $tags = array('webuploadercss' => array('attr' => '', 'close' => 0), 'webuploader' => array('attr' => 'name,url,word', 'close' => 0), 'webuploaderjs' => array('attr' => '', 'close' => 0), );
	// webuploader的css部分和jquery因为插件需要引在jquery后边；所以在头部引入了jquery
	public function _webuploadercss() {
		$str = <<<php
<link rel="stylesheet" href="__PUBLIC__/Common/webuploader/xb-webuploader.css">
...
php;
	...
	public function _webuploaderjs() {
		$str = <<<php
<script>
    var BASE_URL = '__PUBLIC__/Common/webuploader';
</script>
